...
const runCmd = function () {
  ...
  }).command('app', 'List and modify your VIP applications').command('import', 'Import Media or SQL files into your VIP applications').command('search-replace', 'Perform Search and Replace tasks on files').command('sync', 'Sync production to a development environment').command('wp', 'Run WP CLI commands against an environment').command('dev-env', 'Use local dev-environment');
